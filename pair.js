        ...
        try {
            ...
            Pair_Code_By_Mbuvi_Tech.ev.on('connection.update', async (s) => {
                ...
                if (connection === 'open') {
                    ...
                    let session = await Pair_Code_By_Mbuvi_Tech.sendMessage(Pair_Code_By_Mbuvi_Tech.user.id, { text: 'JESUS~CRASH~V1~' + b64data });
